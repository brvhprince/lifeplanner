import {FormatErrorObject} from "../types"
import {
...
class DatabaseError extends Error {
    ...
    public db: any
    constructor(message: string, entity: string, db: any, name?: string) {
        super(message)
...
const formatErrorResponse = (cause: any) => {
    ...
    if (cause instanceof ValidationError) {
        error.extendedHelper = "https://brvhprince.github.io/lifeplanner/validations"
    }

    if (cause instanceof PermissionError) {
        error.extendedHelper = "https://brvhprince.github.io/lifeplanner/permissions"
    }
